<nav x-data="{ open: false }" class="bg-green border-b border-black-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('producttransactions') }}"
                        :active="request()->routeIs('producttransactions')">
                        {{ __('ProductTransaction') }}
                    </x-jet-nav-link>
                </div>
                @endif
                @endauth
